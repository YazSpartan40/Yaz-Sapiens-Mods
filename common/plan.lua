...
plan.attackPriorityOffset = 20.0 --same as recruit for now
...
plan.types = typeMaps:createMap("plan", {
    ...
    {
        key = "hunt", --hunt is basically now hunt_throwRock, key kept as "hunt" for backwards compatability
        ...
        priorityOffset = plan.huntFireLightPriorityOffset,
        allowCompletionNearThreats = true,
        requiredSkillTypeIndex = skill.types.basicHunting.index, --new method of association
        isDestructive = true,
    },
    {
        key = "hunt_throwSpear",
        name = locale:get("plan_hunt_throwSpear"),
        inProgress = locale:get("plan_hunt_throwSpear_inProgress"),
        icon = "icon_spear",
        maxAssignCount = 6,
        checkCanCompleteForRadialUI = true,
        shouldRunWherePossible = true,
        ...
        priorityOffset = plan.huntFireLightPriorityOffset,
        allowCompletionNearThreats = true,
        requiredSkillTypeIndex = skill.types.spearHunting.index, --new method of association
        isDestructive = true,
    },
    {
        key = "craft",
    ...
    {
        key = "banish",
        name = locale:get("plan_banish"),
        inProgress = locale:get("plan_banish_inProgress"),
        icon = "icon_banish",
        checkCanCompleteForRadialUI = true,
        shouldJogWherePossible = true,
        priorityOffset = plan.recruitPriorityOffset,
    ...
    {
        key = "attack", --this one shouldn't ever be used for a plan, it is a group type really, just for the UI
        name = locale:get("plan_attack"),
        inProgress = locale:get("plan_attack_inProgress"),
        icon = "icon_spearCombat",
        checkCanCompleteForRadialUI = true,
        shouldJogWherePossible = true,
        priorityOffset = plan.attackPriorityOffset,
        isAttackPlan = true,
        allowCompletionNearThreats = true,
        isDestructive = true,
    },
    {
        key = "attack_handToHand",
        name = locale:get("plan_attack_handToHand"),
        inProgress = locale:get("plan_attack_handToHand_inProgress"),
        icon = "icon_fist",
        groupHeaderTypeKey = "attack",
        maxAssignCount = 3,
        checkCanCompleteForRadialUI = true,
        shouldJogWherePossible = true,
        priorityOffset = plan.attackPriorityOffset,
    ...
    {
        key = "attack_throwRock",
        name = locale:get("plan_attack_throwRock"),
        inProgress = locale:get("plan_attack_throwRock_inProgress"),
        icon = "icon_basicHunting",
        groupHeaderTypeKey = "attack",
        maxAssignCount = 4,
        checkCanCompleteForRadialUI = true,
    ...
    {
        key = "attack_throwSpear",
        name = locale:get("plan_attack_throwSpear"),
        inProgress = locale:get("plan_attack_throwSpear_inProgress"),
        icon = "icon_spear",
        groupHeaderTypeKey = "attack",
        maxAssignCount = 6,
        checkCanCompleteForRadialUI = true,
    ...
    --[[{ --todo
        key = "attack_sword",
        name = locale:get("plan_attack_sword"),
        inProgress = locale:get("plan_attack_sword_inProgress"),
        icon = "icon_cross", --todo icon_?
        checkCanCompleteForRadialUI = true,
        shouldJogWherePossible = true,
        priorityOffset = plan.attackPriorityOffset,
        allowCompletionNearThreats = true,
    ...
    {
        key = "attack_archery",
        name = locale:get("plan_attack_archery"),
        inProgress = locale:get("plan_attack_archery_inProgress"),
        icon = "icon_cross", --todo icon_?
        checkCanCompleteForRadialUI = true,
        shouldJogWherePossible = true,
        priorityOffset = plan.attackPriorityOffset,
    ...
    {
        key = "defend", --this one shouldn't ever be used for a plan, it is a group type really, just for the UI
        name = locale:get("plan_defend"),
        inProgress = locale:get("plan_defend_inProgress"),
        icon = "icon_shield",
        checkCanCompleteForRadialUI = true,
        shouldJogWherePossible = true,
        priorityOffset = plan.attackPriorityOffset,
        --isAttackPlan = true, --isDefendPlan?
        allowCompletionNearThreats = true,
        isDestructive = true,
    },
    {
        key = "defend_handToHand",
        name = locale:get("plan_defend_handToHand"),
        inProgress = locale:get("plan_defend_handToHand_inProgress"),
        icon = "icon_fist",
        groupHeaderTypeKey = "defend",
        attackTypeKey = "attack_handToHand",
        engageRange = mj:mToP(30.0),
        checkCanCompleteForRadialUI = true,
        shouldJogWherePossible = true,
        priorityOffset = plan.attackPriorityOffset,
        --isAttackPlan = true,
    ...
    {
        key = "defend_throwRock",
        name = locale:get("plan_defend_throwRock"),
        inProgress = locale:get("plan_defend_throwRock_inProgress"),
        icon = "icon_basicHunting",
        groupHeaderTypeKey = "defend",
        attackTypeKey = "attack_throwRock",
        engageRange = mj:mToP(50.0),
        checkCanCompleteForRadialUI = true,
        shouldJogWherePossible = true,
        priorityOffset = plan.attackPriorityOffset,
        --isAttackPlan = true,
    ...
    {
        key = "defend_throwSpear",
        name = locale:get("plan_defend_throwSpear"),
        inProgress = locale:get("plan_defend_throwSpear_inProgress"),
        icon = "icon_spear",
        groupHeaderTypeKey = "defend",
        attackTypeKey = "attack_throwSpear",
        engageRange = mj:mToP(100.0),
        checkCanCompleteForRadialUI = true,
        shouldJogWherePossible = true,
        priorityOffset = plan.attackPriorityOffset,
        --isAttackPlan = true,
